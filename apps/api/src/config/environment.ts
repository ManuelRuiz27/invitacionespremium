...
export const environmentSchema = z
  .object({
    ...
    FLOORPLAN_SVG_MAX_BYTES: z.coerce.number().int().positive().default(5_242_880),
    FLOORPLAN_SVG_MAX_NODES: z.coerce.number().int().positive().default(5_000),
    FLOORPLAN_SVG_MAX_DEPTH: z.coerce.number().int().positive().default(64),
