...
describe('deriveFloorplanSvgSource', () => {
  const transformedBox = (transform: string) => deriveFloorplanSvgSource('asset', Buffer.from(
  ...
  it.each([
    'skewZ(20)', 'translate(10) bogus(20)', 'junk translate(10)', 'translate(10) junk',
    'translate()', 'translate(1 2 3)', 'scale()', 'scale(1 2 3)', 'rotate(10 20)',
    'rotate(1 2 3 4)', 'matrix(1 0 0 1 0)', 'skewX(1 2)', 'skewY()',
    'translate(1,,2)', 'translate(1,)', 'translate(,1)', 'translate(10px)',
    'translate(0x10)', 'translate(NaN)', 'translate(Infinity)', 'translate(1e309)',
    'translate(1', 'translate((1))', 'translate(1),', 'translate(1),,scale(2)',
  ...
  it('rejects malformed transforms on ancestors and finite inputs whose composition overflows', () => {
    for (const transform of ['unknown(2)', 'scale(1e308)']) {
      expect(() => deriveFloorplanSvgSource('asset', Buffer.from(
