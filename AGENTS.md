...
17. Antes de crear, modificar o inferir roles, ownership, superficies o permisos para un nuevo escenario comercial (Planner, salón/jardín, agencia, reseller, licencia, instancia dedicada u otro), leer `docs/01-producto/06_MODELOS_OPERATIVOS_DE_VENTA.md` y el modelo especializado aplicable. Un escenario comercial no autoriza por sí mismo un nuevo rol ni una nueva capacidad: primero debe existir modelo aprobado, gap analysis y ticket técnico explícito.
