...
8. `docs/02-flujos-reglas/06_FINANZAS_CREDITOS_CONTABILIDAD.md`
9. `docs/02-flujos-reglas/LEDGER_TYPES.md`
10. `docs/03-ui-ux/07_UI_UX_FLOW.md`
11. `docs/04-tecnico/08_TRD.md`
12. `docs/04-tecnico/09_MODELO_DATOS_CONCEPTUAL.md`
13. `docs/04-tecnico/10_SCHEMA_PRISMA_GUIDE.md`
14. `docs/04-tecnico/11_API_CONTRACTS.md`
15. `docs/04-tecnico/12_REPOS_Y_APPS.md`
16. `docs/04-tecnico/FILE_ASSET_POLICY.md`
17. `docs/04-tecnico/REALTIME_PAYLOADS.md`
