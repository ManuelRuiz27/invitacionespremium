...
import { clampSeatGroupDelta, normalizeFloorplanShape, polygonClipPath, screenDeltaToLocal } from './floorplan-geometry';
...
describe('clampSeatGroupDelta', () => {
  it.each([
    [[{ x: 0.2, y: 0.2 }, { x: 0.3, y: 0.3 }], { x: 0.1, y: 0.1 }, { x: 0.1, y: 0.1 }],
    [[{ x: 0.85, y: 0.85 }, { x: 0.95, y: 0.95 }], { x: 0.1, y: 0.1 }, { x: 0.05, y: 0.05 }],
    [[{ x: 0.05, y: 0.05 }, { x: 0.15, y: 0.15 }], { x: -0.1, y: -0.1 }, { x: -0.05, y: -0.05 }]
