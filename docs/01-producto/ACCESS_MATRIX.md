...
| Listar/descargar SVG de pases físicos    | No por operación cliente                | Propio                | Organización                                 | Creados                                      | No                              | No                               |
| Usar pase físico                         | No                                      | No                    | No                                           | No                                           | Token del mismo Evento           | No                               |
...
| `GET /public/albums/:albumToken/photos/:photoId/content` | Mismo token revalidado en cada request; foto activa `READY` del Álbum resuelto, entrega privada sin PII ni metadata interna. |
