...
7. Contrato de implementación del ticket activo (`FP01_PROVIDER_FLOORPLAN_SHELL.md`, `FP02_STICKER_CATALOG.md`, `FP03_FLOORPLAN_INTERACTION_ROBUSTNESS.md`, `FP04_PLANNER_SEATING_WORKSPACE_ALIGNMENT.md`, `FP05_SCALE_OPERATION_QA.md`, `PILOT01_END_TO_END_READINESS.md`, etc.).
