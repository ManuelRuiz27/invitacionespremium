...
| `active` | Llegar al día operativo del evento | `event_day` | Sistema | Fecha/hora y zona horaria del Evento | Emitir `event.day_started` si se implementa; no duplicar cobros. |
